...
<div class="sidebar" id='sidebar'>
  <?php
   ...
   ?>
     ...
     <a class='anchor' href="../admin/view_all_appointments.php">        <i class="fa-solid fa-calendar-check fa-2x"></i><span id='here_we_go'>All Appointments</span></a>
     <a class='anchor' href="../admin/list_doctors.php"><i class="fa-solid fa-user-doctor fa-2x"></i><span id='here_we_go'>Doctors</span></a>
     <a class='anchor' href="../admin/list_patients.php">
      <i class="fa-solid fa-user fa-2x"></i><span id='here_we_go'>Patients
    </span></a>
     <a class='anchor' href="../admin/search_history.php"><i class="fa-solid fa-magnifying-glass fa-2x"></i><span id='here_we_go'>Search</span></a>
     <a class='anchor' href="../admin/services.php"><i class="fa-solid fa-bed-pulse fa-2x"></i><span id='here_we_go'>Services</span></a>
     <a class='anchor' href="../admin/view_cancelled_appointments.php">
   ...
   <?php
    ...
    ?>
        ...
        <a class='anchor' href="../doctor/view_appointments.php">View appointment doctor</a>
   <?php
    }
    else
    {
