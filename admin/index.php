...
<script>
   ...
   function chart2(data1,data2,id,text){
          console.log(data1)
    var options = {
          series: [{
...
<script>
                ...
                if (xhr.readyState === DONE) {
                    if (xhr.status === OK) {
                     ...
                     console.log(data); // 'This is the returned text.'
                      ...
                      if(id=="1")  chart2(arr2,arr1,"#chart1","Number of appointments in graph");
                        if(id=="2") chart2(arr2,arr1,"#chart2","Total turnovers till date");
                    } else {
    ...
    chart1("charts.php?id=","1");
    chart1("charts.php?id=","2");
